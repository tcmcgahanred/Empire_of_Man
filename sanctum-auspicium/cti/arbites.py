...
# Sanctum Auspicium · Arbites · v0.4 (starting anchor; history via git)
"""
Ravenor — CCIC WCTI pre-filter / scorer.
...
DOCTRINE (from CCIC_WCTI_intelligence_requirements.md, Layer 4):
...
INTEGRATION / WHAT TO VERIFY ON RAVENOR:
...
# ------------------------------------------------------------------
# CONFIG — verify these paths on Ravenor
# ------------------------------------------------------------------
...
def main():
    ...
    lines = []
    lines.append("# CCIC WCTI — Pre-Filtered Candidate Queue")
