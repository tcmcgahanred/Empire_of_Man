# empire_of_man — 2026 Build Log & Changelog (Active)

This is the active build log for the 2026 detection-engineering-focused
rebuild (Lenovo VS + R640 EoM). For the earlier 2025 SOCaaS/MSSP-era
work that preceded this pivot, see the archived
`deployment-changelog-2025-ARCHIVE.md`.
